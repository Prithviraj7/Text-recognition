function [] = jrsy (srcFolder, trgFolder, typeImg)

% INPUT SAMPLES
% srcFolder = 'C:\Users\Ayan\Desktop\Jersey Numbers-New\Jersey Numbers-New\Bhavana\Original\';
% trgFolder = 'C:\Users\Ayan\Desktop\Jersey Numbers-New\Jersey Numbers-New\Bhavana\Original\patches\';
% typeImg = 'jpg';

if exist(trgFolder, 'dir') ~= 7
    mkdir(trgFolder);
end

files=dir([srcFolder, '*.', typeImg]);

for Index = 1:numel(files)
    
    file = files(Index).name;
    colorImage = imread([srcFolder,file]);
    ...
    for i=1:size(rexpandedBBoxes,1)
        imwrite((imcrop(colorImage, rexpandedBBoxes(i,:))),...
            strcat(trgFolder,file,'\',num2str(i),'.jpg'));
